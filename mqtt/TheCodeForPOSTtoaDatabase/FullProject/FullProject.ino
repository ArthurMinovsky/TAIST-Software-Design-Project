...
const char* serverName = "http://dc5d-124-122-218-230.ngrok.io/api/inject_logging";// API link
...
void loop() {
  ...
  if (oldcardid != cardid) {
    ...
    if(WiFi.status()== WL_CONNECTED){
      ...
      int httpResponseCode = http.POST("{\"cardid\":\""+String(cardid)+"\"}");
